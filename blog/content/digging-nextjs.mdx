---
title: 'Next.js 코드 뜯어보기'
publishedAt: '2023-06-29'
summary: '원티드 프리온보딩 챌린지(FE, 7월) 사전과제'
image: '/images/digging-nextjs/1.png'
---

<Image src='/images/digging-nextjs/1.png' alt='1' width={1686} height={882} />
...
<Image src='/images/digging-nextjs/2.png' alt='2' width={939} height={358} />
...
```tsx
...
export async function startServer({...}: StartServerOptions): Promise<TeardownServer> {
  ...
  try {
    if (useWorkers) {
      ...
      const routerWorker = new Worker(renderServerPath, {...}) as any as InstanceType<typeof Worker> & {
...
<Image src='/images/digging-nextjs/3.png' alt='3' width={1536} height={1088} />
...
<Image src='/images/digging-nextjs/4.png' alt='4' width={1528} height={1202} />
